...
from apps.ambient import conf
import random


class AmbientHandler(object):
    def __init__(self, matrix, parent):
        ...
        self.games = conf.apps
        self.standby_apps = conf.standby_apps
    ...
    def standby(self):
        self.active = random.choice(self.standby_apps)(self.matrix, self)
